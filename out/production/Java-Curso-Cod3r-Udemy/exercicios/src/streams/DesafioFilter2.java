...
public class DesafioFilter2 {
	...
	public static void main(String[] args) {
		...
		Produto p2 = new Produto("Notebook", 4890.90, 0.32, 0);
		Produto p3 = new Produto("Impressora", 1200, 0.40, 0);
		Produto p4 = new Produto("Caneta", 4.99, 0.29, 30);
		Produto p5 = new Produto("Monitor", 800, 0.12, 0);
		Produto p6 = new Produto("Relogio", 1900, 0.31, 0);
