...
public class ConversaoTipoPrimitivoNumerico {
	...
	public static void main(String[] args) {
		...
		float b = 1.0F; // EXPLICITANDO que 1.0 é float, logo o Java não converte nem interpreta
						// diferente disso
...
//		byte d_byte = c; //ERRO - necessário conversão
		byte d_byte = (byte) c;
		System.out.println("int -> byte: " + d_byte); // foi para o "proximo" numero do range, 127 (NUM LIMITE) foi para
														// -128 (NUM MIN LIMITE)
	}
}
